...
import com.mayank786da.microservice.service.VendorService;
...
public class VendorController {
  ...
  public Optional<Vendor> getSingleVendors(@PathVariable("vendorId") String vendorId) {
  ...
  public List<Vendor> lookupByFirstName(@PathVariable("firstName") String firstname){
