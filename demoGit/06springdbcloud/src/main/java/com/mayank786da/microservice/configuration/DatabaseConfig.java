package com.mayank786da.microservice.configuration;
...
public class DatabaseConfig extends AbstractCloudConfig {
	...
	@Value("${vcap.services.postgresql.credentials.username}")
	private String username;

	@Value("${vcap.services.postgresql.credentials.password}")
	private String password;

	@Value("${vcap.services.postgresql.credentials.hostname}")
	private String hostname;

	@Value("${vcap.services.postgresql.credentials.port}")
	private String port;

	@Value("${vcap.services.postgresql.credentials.dbname}")
